...
const MOCK_DATA = {
  ...
  animalTypes: ['Cow', 'Goat', 'Sheep', 'Poultry'],
  ...
  mockListings: (function () {
    ...
    const types = ['Cow', 'Goat', 'Sheep', 'Poultry'];
    ...
    for (let i = 0; i < 52; i++) {
      ...
      const basePrice = type === 'Cow' ? 900000 + (i % 6) * 150000 : type === 'Goat' ? 200000 + (i % 5) * 50000 : type === 'Sheep' ? 250000 + (i % 4) * 25000 : 25000 + (i % 3) * 5000;
      const weight = type === 'Cow' ? 280 + (i % 12) * 25 : type === 'Poultry' ? 1.5 + (i % 5) * 0.5 : 25 + (i % 15) * 5;
      const age = type === 'Cow' ? (1 + (i % 8)) + ' years' : type === 'Poultry' ? (3 + (i % 8)) + ' months' : (1 + (i % 4)) + ' years';
      list.push({
        id: 'mock-listing-' + (i + 1),
